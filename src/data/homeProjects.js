const homeProjects = [
	{
		...
		projectInfo: {
			...
			socialSharingsHeading: 'Mis Redes Sociales',
			socialSharings: [
				{
					id: 2,
					name: 'Instagram',
					icon: 'instagram',
					url: 'https://www.instagram.com/randymxd06/',
				},
				{
					id: 1,
					name: 'Github',
				...
				},
				{
					...
					name: 'Facebook',
					icon: 'facebook',
					url: 'https://www.facebook.com/thehairland',
				},
				{
					id: 4,
					name: 'LinkedIn',
				...
				},
				{
					...
					name: 'Youtube',
					icon: 'youtube',
					url: 'https://www.youtube.com/@randymxd06',
				},
			],
		},
		relatedProject: {
